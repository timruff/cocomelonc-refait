...
int main(int argc, char* argv[]) {
  ...
  unsigned char* ciphertext = (unsigned char *)malloc(sizeof(unsigned char) * sizeCipher);
  RC4(plaintext, ciphertext, key, strlen((const char*)key), sizeCipher); 
  ciphertext[sizeCipher]= '\0';
  ...
  unsigned char* decoded = (unsigned char *)malloc(sizeof(unsigned char) * (sizeof(payload)));
  RC4(encoded, decoded, key, strlen((const char*)key), sizeof(payload));
  ...
  unsigned int decoded_payload_len = sizeCipher;
